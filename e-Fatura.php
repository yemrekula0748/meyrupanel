...
// Barkod çıktısı için :) tasarım bok gibi ama iş görür
...
$musteriBilgi = $db->query("SELECT * FROM siparisler WHERE id = '$musteriID'")->fetch_assoc();

// Barkod basım durumunu güncelle
$updateSql = "UPDATE siparisler SET barkod_basilma_durumu = 'Basılmış' WHERE id = ?";
$db->query($updateSql, [$musteriID], "i");


$musteriAdi = $musteriBilgi['musteri_ismi'];
$musteriTelefonu = $musteriBilgi['musteri_telefonu'];
$musteriAdresi = $musteriBilgi['musteri_adresi'];
$musteriOdemeSarti = $musteriBilgi['odeme_sarti'];
$musteriParasutFaturaNumarasi = $musteriBilgi['parasut_fatura_numarasi'];
$musteriUrunler = $musteriBilgi['urunler'];
$musteriHangiSayfa = $musteriBilgi['hangisayfa'];
$musteriSiparisTarihi = $musteriBilgi['siparis_tarihi'];
$musteriIL = $musteriBilgi['musteri_il'];
$musteriILCE = $musteriBilgi['musteri_ilce'];
$musteriBarkodu = $musteriBilgi['kargo_barkodu'];
$sirketismi = $musteriBilgi['hangikargo'];
...
<?php
$odemeSarti = $musteriBilgi['odeme_sarti'];
$birimFiyat = round($odemeSarti / 1.10, 2); // %10 düşüş
$toplamTutar = round($birimFiyat, 2); // Aynı tutar

// KDV hesaplama (%10)
$kdvTutar = round($toplamTutar * 0.10, 2);
?>
        
    <div class="coklu_fatura" style="page-break-after:always">
    ...
    <tr valign="top" align="left">
        <td width="50%">
            ...
            <br>
            <img src="logo.png" width="229" height="56" class="satici_logosu" style="height:50px">
...
?>
    ...
    <tr align="left">
        ...
        <td align="right" valign="top" width="50%" id="ettnTable"><span style="font-weight:bold;color:black;font-size:14px"><span class="style14">Alıcı : <?php echo $musteriAdi; ?></span>&nbsp;</span></td>
    </tr>  
    ...
    <table style="border-color:black;border:none;margin-top:5px" border="1" cellspacing="0px" width="800" cellpadding="0px">
            ...
            <tr>
                <td width="50%" style="border-color:black;">
                    <span style="font-size: 17px"><strong><?php echo $musteriAdi; ?></strong></span><span class="style9"><br>
                    <?php echo $musteriAdresi; ?> <br>
                     TÜRKİYE<br>
                    Müşteri No : <?php echo $musteriTelefonu; ?><br>
                    VKNO : 11111111111<br>
                    </span><span class="style11"><br>              
                    </span></td>
                <td width="50%" style="border-color:black;">
                    <span class="style11" style="font-weight:bold;color:black">Teslimat Bilgileri</span>
                    <span class="style11" style="font-weight:bold;color:black"><?php echo $musteriAdi; ?></span><span class="style11"><strong><br>
                    <span style="color:black"><?php echo $musteriAdresi; ?></span><br>
                    <span style="color:black">TÜRKİYE</span><br>
                    <span style="color:black">Müşteri No : <?php echo $musteriTelefonu; ?></span><br>
...
<tr align="left">
    ...
    <td class="lineTableBudgetTd" style="width:140px " align="left"><h2 class="style7" style="color: black;"><?php echo $musteriParasutFaturaNumarasi; ?></h2> </td>
</tr>
<tr align="left">
    <td class="lineTableBudgetTd" width="130" align="left"><span class="style7" style="font-weight:bold; ">Düzenleme Tarihi : </span></td>
    <td class="lineTableBudgetTd" style="width:140px; " align="left"><span class="style7"><strong><?php echo date("d-m-Y", strtotime($musteriSiparisTarihi)); ?></strong></span></td>
    <td>
    ...
    <td align="left" class="lineTableBudgetTd" style="width:82px; "><span class="style11"><strong>
                    <?php echo sayiyiYaziyaCevir($musteriOdemeSarti); ?>        TL'dir.    </strong></span></td>
...
<table width="802" border="1">
  ...
  <tr>
    <td><span class="style20"><font color="black" face="tahoma"><?php echo $musteriHangiSayfa; ?></font></span></td>
    <td><span class="style20"><font face="tahoma" color="black">ŞARTLI ÖDEME</font></span></td>
    <td><span class="style20"><font face="tahoma" color="black"><?php echo $musteriOdemeSarti; ?>₺</font></span></td>
    <td><span class="style20"><font face="tahoma" color="black"><?php  echo $musteriIL . " / " . $musteriILCE ?></font></span></td>
  </tr>
  <tr>
    <td><span class="style24">Ürünler : </span></td>
    <td colspan="3"><span class="style24"><font color="black" face="tahoma">
	<?php echo $musteriUrunler; ?>	</font></span></td>
...
$barWidth = 3;  // Çizgi genişliği (varsayılan: 2)
$barHeight = 100; // Çubuk yüksekliği (varsayılan: 30)


$barcodeData = $generator->getBarcode($musteriBarkodu, $generator::TYPE_CODE_128, $barWidth, $barHeight);
$dosyaAdi = 'barkodlar/' . $musteriBarkodu . '.png';
file_put_contents($dosyaAdi, $barcodeData);


echo '<img src="' . $dosyaAdi . '" alt="Barkod" style="width: 550px; height: 150px;">';


 ?></center><p></p> <br>
 
 <span class="style24"><font color="black" face="tahoma">
	<center><?php echo $musteriBarkodu; ?>	</font></span></center>
