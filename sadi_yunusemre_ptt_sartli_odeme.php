...
try {
    ...
    $iteration = 0; // Çalışma sayısını takip eder
    $max_iterations = 59; // Maksimum çalıştırma sayısı
    ...
    while ($iteration < $max_iterations) {
        ...
        echo "İşlem tamamlandı. Tekrar denenecek.\n";
    ...
    echo "59 tekrar tamamlandı, işlem durduruldu.\n";
